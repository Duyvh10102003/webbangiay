        ...
        <form asp-action="Create" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        <label asp-for="AudioFileUrl" class="control-label">Sách nói</label>
                        <input type="file" asp-for="AudioFileUrl" class="form-control" id="audioInput" onchange="previewAudio(event)" />
                        <!-- Hiển thị file audio cũ nếu có -->
                        <div id="audioPreviewContainer" class="mt-2">
                            <audio id="audioPreview" controls style="display: none; width: 100%;">
