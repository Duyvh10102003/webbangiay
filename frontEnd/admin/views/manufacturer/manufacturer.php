...
<h2 class="text-center mb-4">Danh sách nhà sản xuất</h2>

<div class="d-flex justify-content-between align-items-center mb-4">
    <a href="http://localhost/webbangiay/frontEnd/admin/views/manufacturer/create.php" class="btn btn-success btn-lg">Thêm Mới</a>
...
<table id="books" class="table table-striped table-bordered table-hover">
    <thead class="thead-dark text-center">
        <tr>
            ...
            <th class="align-top">
                <i class="fa-solid fa-book"></i> Tên nhà sản xuất
            </th>
            <th class="align-top">
...
<?php include __DIR__ . '/../shares/footer.php'; ?>
    ...
    <script>
  const API_URL = "http://localhost/webbangiay/api/manufacturer"; // Địa chỉ API để lấy danh sách sản phẩm
